...
class Events extends StatelessWidget {
  ...
  events({required int count, required double ratio, required List<Post> posts,required double mainAxisSpacing, required double crossAxisSpacing ,required double textPadding,required double fontSize}) {
    return SizedBox(
      ...
      child: Column(
        children: [
          ...
          Padding(
            ...
            child: events(count: 2, ratio: 6/4, posts: homeController.events, mainAxisSpacing: 30,
    ...
    return SingleChildScrollView(
      child: Column(
        children: [
          ...
          Padding(
            padding: EdgeInsets.symmetric(horizontal: MediaQuery.of(context).size.width*0.1),
            child: events(count: 2, ratio: 1.4, posts: homeController.events, mainAxisSpacing: 30,
    ...
    return SingleChildScrollView(
      child: Column(
        children: [
          ...
          Padding(
            padding: EdgeInsets.symmetric(horizontal: MediaQuery.of(context).size.width*0.1),
            child: events(count: 2, ratio: 1.4, posts: homeController.events, mainAxisSpacing: 20,
