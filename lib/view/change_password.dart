...
import 'package:animals/controller/change_password_controller.dart';
                    ...
                    Container(
                      ...
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                            ...
                            suffix: IconButton(
                                onPressed: () {
                                  changePasswordController.hide1.value =
                                      !changePasswordController.hide1.value;
                                },
                                icon: Icon(
                                  changePasswordController.hide1.value
                            ...
                            errorText:
                                changePasswordController.validate.value &&
                                        changePasswordController
                                            .oldPassword.text.isEmpty
                                    ? App_Localization.of(context)
                                        .translate("old_password_required")
                                    : null),
                      ),
                    ),
                    SizedBox(
                    ...
                    Container(
                      ...
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                            ...
                            suffix: IconButton(
                                onPressed: () {
                                  changePasswordController.hide2.value =
                                      !changePasswordController.hide2.value;
                                },
                                icon: Icon(
                                  changePasswordController.hide2.value
                    ...
                    Container(
                      ...
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                            ...
                            suffix: IconButton(
                                onPressed: () {
                                  changePasswordController.hide3.value =
                                      !changePasswordController.hide3.value;
                                },
                                icon: Icon(
                                  changePasswordController.hide3.value
