...
import 'package:animals/controller/profile_controller.dart';
import 'package:animals/helper/api.dart';
import 'package:animals/helper/app.dart';
import 'package:animals/helper/store.dart';
import 'package:animals/view/change_password.dart';
import 'package:animals/view/login.dart';
import 'package:animals/view/signup.dart';
          ...
          children: [
            Column(
              ...
              children: [
                          ...
                          child: Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                CircleAvatar(
                                    radius: 40,
                                    child: API.customer!.image.length == 0
                                        ? Icon(
                                            Icons.person,
                                            size: 65,
                                          )
                ...
                ListTile(
                  onTap: () {
                    profileController.getMyOrder(context);
                  },
                  autofocus: true,
                  title:
                      Text(App_Localization.of(context).translate("my_orders")),
                  subtitle: Text(App_Localization.of(context)
                      .translate("my_orders_sub_title")),
                ...
                ListTile(
                  ...
                  subtitle:
                      Text(Store.languageCode == "en" ? "English" : "العربية"),
                  leading: CircleAvatar(
                    child: Icon(Icons.language),
                  ),
                ),
                ListTile(
                  ...
                  autofocus: true,
                  title: Text(App_Localization.of(context)
                      .translate("change_password")),
                  subtitle: Text(App_Localization.of(context)
                      .translate("change_password_sub_title")),
                  leading: CircleAvatar(
                ...
                ListTile(
                  ...
                  subtitle: Text(App_Localization.of(context)
                      .translate("delete_account_sub_title")),
                  leading: CircleAvatar(
        ...
        child: Column(
          ...
          children: [
            Text(App_Localization.of(context)
                .translate("are_u_sure_delete_account")),
          ],
        ),
      ),
